...
public class GroupStepDefs {
    ...
    public void iJoinInAGroupWithAccessCode() {
        ...
        joinGroupPopup.join(context.getValue("AccessCode"));
    }
    ...
    @And("I save the group code with {string} user")
    public void iSaveAnAccessCodeOfGroup(final String instructorName) {
        Group group = new Group();
        String code = group.getAccessCode();
        context.setContext("AccessCode", code);
        context.setContext("InstructorName", instructorName);
    }
    ...
    public void iAddAPost(final String descriptionPost) {
        Group group = new Group();
        group.saveDescriptionPost(descriptionPost);
    }
    ...
    public void iShouldSeeAPostWithAsDescription(final String descriptionPost) {
        Assert.assertEquals(descriptionPost, new Group().getPostByDescription(descriptionPost));
    }
